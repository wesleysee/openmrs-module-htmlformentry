...
<c:set var="inPrintableFormat" value="${param.inPrintableFormat != null && param.inPrintableFormat}"/>

<c:if test="${not pageFragment}">
    <c:set var="DO_NOT_INCLUDE_JQUERY" value="true"/>
	<c:choose>
		<c:when test="${inPopup || inPrintableFormat}">
